...
public class DataDownloadApp : IApp
{
    public void Run()
    {
        IDataDownloader<string, string> dataDownloader = new SlowDataDownloader(new CachingManager<string, string>());
        ...
        IDataDownloader<int, DateTime> dataDownloader2 = new SlowDateTimeDownloader(new CachingManager<int, DateTime>());
